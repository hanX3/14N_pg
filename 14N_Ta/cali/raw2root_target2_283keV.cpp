...
void raw2root_target2_283keV()
{
  TFile *fi = TFile::Open("../../../data/14N_Ta/target2/283keV/target2_283keV.root");
  if(fi->IsZombie()){
  ...
  TFile *fo = new TFile("rootfile/target2_283keV_cali.root", "recreate");
  fo->cd();
  h_cali->Write();
