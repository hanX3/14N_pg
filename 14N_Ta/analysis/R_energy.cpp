...
void R_energy()
{
  ...
  TFile *fi1 = TFile::Open("../cali/rootfile/target2_281keV_cali.root");
  TFile *fi2 = TFile::Open("../cali/rootfile/target2_283keV_cali.root");
  TFile *fi3 = TFile::Open("../cali/rootfile/target2_285keV_cali.root");
