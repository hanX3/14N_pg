...
constexpr G4double GeR  = 35.5 * mm;
constexpr G4double GeHeight  = 72 * mm;
...
constexpr G4double LN2HoleR = 5 * mm;
constexpr G4double LN2HoleDeep = 56 * mm;
...
constexpr G4double ParticleEnergy = 353. *keV;
